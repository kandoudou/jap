...
<div id="locationField">
      <input id="autocomplete" name="question" placeholder="Enter your address"
    ...
    <table id="address">
      <tr>
        ...
        <td class="slimField"><input class="field" name="address_number" id="street_number"
      ...
      <tr>
        ...
        <td class="wideField"><input class="field" name="address_postal_code" id="postal_code"
              disabled="true"></input></td>
      </tr>
      <tr>
